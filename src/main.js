...
const resumeData = {
  name: "Ahn Sungjin",
  title: "Enterprise GenAI Architect + Product Lead",
  description: "대규모 IT/DX 프로젝트 총괄 경험을 바탕으로, 생성형 AI(vLLM · Multi-Agent · RAG · MCP)를 활용해 엔터프라이즈 환경의 복잡한 비즈니스 문제를 해결하는 AI Product Lead입니다. 기술 아키텍처 설계부터 AI 서비스 제품화까지 전 과정을 End-to-End로 리딩합니다.",
  coreRoles: [
    {
      title: "1. GenAI Platform Architecture & Integration Lead",
      subTitle: "GenAI 플랫폼 아키텍처 설계 및 통합 리딩",
      bullets: [
        "엔터프라이즈 환경(On-Premise / Cloud)에서 GenAI 플랫폼 아키텍처 설계 및 기술 전략 수립",
        "Kubernetes 기반 인프라 제약을 고려한 생성형 AI 파이프라인 설계 및 운영 이슈 해결 리딩",
        "레거시 및 내부 시스템과의 연계를 포함한 End-to-End 통합 아키텍처 설계",
        "정형/비정형 데이터 통합 처리 기반의 AI 서비스 아키텍처 및 데이터 파이프라인 총괄"
      ]
    },
    {
      title: "2. Agentic AI Workflow & Product Leadership",
      subTitle: "Agentic AI 워크플로우 및 제품 리딩",
      bullets: [
        "요구사항 정의부터 설계, 개발, 배포까지 AI 제품 Lifecycle 전반 리딩 (PM 역할)",
        "LLM 및 Agentic AI 구조 이해를 기반으로 Multi-Agent Workflow 설계",
        "단일 챗봇을 넘어 Task 기반 Sub-Agent 협업 구조 및 자동화 파이프라인 설계",
        "도메인 특화 AI 서비스 기획 및 실제 업무 생산성 개선 모델 설계"
      ]
    },
    {
      title: "3. AI-driven Productivity & Rapid Prototyping",
      subTitle: "AI 기반 생산성 혁신 및 빠른 실행",
      bullets: [
        "AI 기반 업무 자동화 및 생산성 향상을 위한 실험 및 적용 지속 추진",
        "바이브 코딩 및 AI 도구 활용한 빠른 PoC 및 내부 서비스 프로토타이핑 주도",
        "기획 → 개발 → 배포까지 End-to-End 직접 수행을 통한 실행력 확보",
        "불확실한 환경에서 빠른 검증과 의사결정을 가능하게 하는 프로토타이핑 전략 운영"
      ]
    },
    {
      title: "4. LLM Systems & AI Infrastructure Architecture",
      subTitle: "LLM 시스템 및 AI 인프라 아키텍처",
      bullets: [
        "LLM 기반 AI 시스템 아키텍처 설계 및 전체 구축 Lifecycle 리딩",
        "RAG, Tool Calling, Agent Orchestration을 결합한 복합 AI 서비스 구조 설계",
        "GPU 인프라 기반 대규모 추론 환경 설계 및 vLLM 최적화 경험",
        "성능, 비용, 지연시간을 고려한 대규모 AI 서비스 인프라 설계 및 운영"
      ]
    }
  ]
};
...
// --- PROJ7 Section Templates ---
// ── PROJ6 (현대/기아 360° 3D Configurator) ──────────────────
const PROJ6_S_OVERVIEW = `
...
/* ──────────────────────────────────────────
   PROJ3 — WBS 기반 사내 통합 프로젝트 관리 시스템
────────────────────────────────────────── */
const PROJ3_S_OVERVIEW = `
...
/* ──────────────────────────────────────────
   PROJ8 — 기아 남양연구소 가상 디자인 품평장
────────────────────────────────────────── */
const PROJ8_S_OVERVIEW = `
...
const portfolioData = [
  {
    ...
    period: "2025.12 ~ 진행 중 | GenON AI",
    tags: ["On-Premise", "RAG", "Multi-Agent", "vLLM", "K8s", "금융권 폐쇄망", "AI포탈구축"],
    ...
    sections: [
      { id: "overview",      title: "overview",               body: PROJ1_S_OVERVIEW },
      { id: "decisions",     title: "problem_solving",        body: PROJ1_S_DECISIONS },
      { id: "architecture",  title: "system_architecture",    body: PROJ1_S_ARCH },
      { id: "stack",         title: "core_architecture_&_technologies", body: PROJ1_S_STACK },
      { id: "principles",    title: "핵심_아키텍처_및_시스템_설계_원칙",  body: PROJ1_S_PRINCIPLES },
    ]
  },
  {
    id: "proj2",
    ...
    sections: [
      { id: "overview",      title: "overview",             body: PROJ2_S_OVERVIEW },
      { id: "decisions",     title: "problem_solving",       body: PROJ2_S_DECISIONS },
      { id: "features",      title: "key_features",         body: PROJ2_S_FEATURES },
      { id: "architecture",  title: "system_architecture",  body: PROJ2_S_ARCH },
      { id: "stack",         title: "core_architecture_&_technologies", body: PROJ2_S_STACK },
      { id: "usecases",      title: "use_cases",            body: PROJ2_S_USECASES },
    ]
  },
  {
    id: "proj3",
    ...
    coverIcon: "⚙️",
    summary: "AI 스타트업 내부에서 사용하는 프로젝트 WBS 관리 시스템과 AI PM 온보딩 가이드 대시보드를 직접 기획하고 Vibe Coding 방식으로 개발하여 실무 적용한 풀스택 웹 애플리케이션.",
    techStack: ["React 19 (Vite)", "Node.js / Express.js", "PostgreSQL 16", "Docker Compose", "Nginx", "JWT + Google OAuth 2.0"],
    sections: [
      { id: "overview",      title: "overview",          body: PROJ3_S_OVERVIEW },
      { id: "problems",      title: "problem_solving",   body: PROJ3_S_PROBLEMS },
      { id: "features",      title: "key_features",      body: PROJ3_S_FEATURES },
      { id: "results",       title: "results",           body: PROJ3_S_RESULTS },
    ]
  },
  {
    id: "proj4",
    title: "ARIBOX & GENGA — AI 기반 3D 컨텐츠 자동화 플랫폼",
    role: "프로젝트 총괄 및 AI 기반 플랫폼 전략 수립",
    ...
    coverIcon: "🧊",
    summary: "딥러닝·생성형 AI·Gaussian Splatting 기술을 융합한 3D 콘텐츠 자동화 플랫폼 구축. 네이버 브랜드 스토어 공식 3D 솔루션 파트너 선정, 30개 이상 글로벌 브랜드 서비스 제공.",
    techStack: ["Photogrammetry", "Vision AI", "Gaussian Splatting", "Deep Learning", "Generative AI", "Blender"],
    sections: [
      { id: "overview",       title: "overview",           body: PROJ4_S_OVERVIEW },
      { id: "problems",       title: "problem_solving",    body: PROJ4_S_PROBLEMS },
      { id: "contributions",  title: "key_contributions",  body: PROJ4_S_CONTRIBUTIONS },
      { id: "results",        title: "results",            body: PROJ4_S_RESULTS },
    ]
  },
  {
    id: "proj5",
    title: "건돌이닷컴 — AI 기반 소셜 미디어 통합 분석 SaaS 플랫폼",
    role: "프로젝트 총괄 및 AI 기반 서비스 전략 수립",
    period: "2019.08 ~ 2021.02",
    tags: ["SNS API", "NLP", "AWS Cloud", "RPA", "SaaS"],
    coverColor: "linear-gradient(135deg, #0a2e1a 0%, #1a3d2a 50%, #0d1f14 100%)",
    coverIcon: "📊",
    summary: "Instagram·Facebook·YouTube 다중 SNS 채널 데이터를 통합 분석하고 NLP로 마케팅 인사이트를 제공하는 SaaS 플랫폼 기획 및 상용화. 유료 계정 2,500+, Meta 공식 미디어 파트너 API 승인 획득.",
    techStack: ["Meta Graph API", "YouTube Data API", "NLP", "AWS Cloud", "RPA", "SaaS"],
    sections: [
      { id: "overview",   title: "overview",          body: PROJ5_S_OVERVIEW },
      { id: "problems",   title: "problem_solving",   body: PROJ5_S_PROBLEMS },
      { id: "features",   title: "key_features",      body: PROJ5_S_FEATURES },
      { id: "results",    title: "results",           body: PROJ5_S_RESULTS },
    ]
  },
  {
    id: "proj6",
    ...
    summary: "전 세계 현대/기아 자동차 매장에서 사용되는 실시간 3D 차량 정보 제공 플랫폼을 유니티 엔진 기반으로 구축. 3년간 20여 개국 딜러십 글로벌 배포를 총괄.",
    techStack: ["Unity Engine", "Real-time 3D Rendering", "Web API", "글로벌 CDN", "다국어(i18n)"],
    sections: [
      { id: "overview",       title: "overview",              body: PROJ6_S_OVERVIEW },
      { id: "contributions",  title: "key_contributions",     body: PROJ6_S_CONTRIBUTIONS },
      { id: "challenges",     title: "technical_challenges",  body: PROJ6_S_CHALLENGES },
      { id: "stack",          title: "tech_stack",            body: PROJ6_S_STACK },
      { id: "results",        title: "results",               body: PROJ6_S_RESULTS },
    ]
  },
  {
    id: "proj7",
    ...
    sections: [
      { id: "overview",   title: "overview",              body: PROJ7_S_OVERVIEW },
      { id: "decisions",  title: "key_decisions",         body: PROJ7_S_DECISIONS },
      { id: "challenges", title: "technical_challenges",  body: PROJ7_S_CHALLENGES },
      { id: "flow",       title: "system_flow",           body: PROJ7_S_FLOW },
      { id: "stack",      title: "tech_stack",            body: PROJ7_S_STACK },
      { id: "results",    title: "results",               body: PROJ7_S_RESULTS },
    ]
  },
  {
    id: "proj8",
    ...
    coverIcon: "🥽",
    summary: "국내 최초 Antilatency 기반 무선 다중 접속 VR 디자인 품평 시스템을 기아 남양연구소에 구축. 실물 클레이 모델과 VR 시안을 AR 패스스루로 동시 비교하는 혼합현실 품평 환경 구현.",
    techStack: ["VR / MR", "Antilatency Tracking", "Real-time Wireless Streaming", "다중 접속 동기화", "AR 패스스루"],
    sections: [
      { id: "overview",       title: "overview",           body: PROJ8_S_OVERVIEW },
      { id: "problems",       title: "problem_solving",    body: PROJ8_S_PROBLEMS },
      { id: "contributions",  title: "key_contributions",  body: PROJ8_S_CONTRIBUTIONS },
      { id: "results",        title: "results",            body: PROJ8_S_RESULTS },
    ]
  }
];

const PORT_CATEGORIES = {
  'AI플랫폼':   ['proj1', 'proj2', 'proj4', 'proj5'],
  '시스템개발': ['proj3', 'proj6', 'proj7', 'proj8'],
};
    ...
    return `
      <div class="core-role-card">
        <div class="core-role-title">
          ${role.title}
          ${role.subTitle ? `<span class="core-role-subtitle">${role.subTitle}</span>` : ''}
        </div>
        ${bulletList}
      </div>
    `;
    ...
    <div class="hero-panel">
      <div class="hero-inner">
        <div class="hero-text">
          ...
          <p class="hero-desc">${resumeData.description}</p>
...
function _buildPortCards(filter) {
  const list = filter === '전체'
    ? portfolioData
    : portfolioData.filter(p => PORT_CATEGORIES[filter]?.includes(p.id));
  return list.map(proj => {
    const num = String(portfolioData.indexOf(proj) + 1).padStart(2, '0');
    ...
    return `
      <article class="port-card" onclick="openPortfolioDetail('${proj.id}')">
        <div class="port-card-num">${num}</div>
...
window._setPortFilter = function(cat) {
  document.querySelectorAll('.port-filter-btn').forEach(btn => {
    btn.classList.toggle('active', btn.dataset.cat === cat);
  });
  document.getElementById('port-list').innerHTML = _buildPortCards(cat);
};

function renderPortfolio() {
  const filterBtns = ['전체', 'AI플랫폼', '시스템개발'].map(cat => `
    <button class="port-filter-btn${cat === '전체' ? ' active' : ''}" data-cat="${cat}" onclick="window._setPortFilter('${cat}')">${cat}</button>
  `).join('');
  ...
  return `
    <section class="portfolio panel">
      ...
      <div class="port-filter-bar">${filterBtns}</div>
      <div class="port-list" id="port-list">${_buildPortCards('전체')}</div>
    </section>
  `;
}
...
function renderPortfolioDetail(projId) {
  ...
  const chipsHtml = proj.tags.map(t => `<span class="det-chip">${t}</span>`).join('');
  const techHtml  = proj.techStack?.map(t => `<code class="tech-chip">${t}</code>`).join(' ') || '';

  // Sidebar: all projects list
  const sidebarHtml = portfolioData.map((p, i) => `
    <button class="det-sidebar-item${p.id === projId ? ' active' : ''}" onclick="openPortfolioDetail('${p.id}')">
      <span class="det-sidebar-icon">${String(i + 1).padStart(2, '0')}</span>
      <span class="det-sidebar-title">${p.title}</span>
    </button>
  `).join('');

  // Section builder helper
  let secIdx = 0;
  const mkSec = (title, body) => {
    const num = String(++secIdx).padStart(2, '0');
    return `
      <div class="det-section">
        <div class="det-sec-header">
          <span class="det-sec-num">${num}</span>
          <span class="det-sec-title">${title}</span>
          <div class="det-sec-rule"></div>
        </div>
        <div class="det-arch-body">${body}</div>
      </div>
    `;
  };
  ...
  if (proj.sections && proj.sections.length > 0) {
    contentHtml = proj.sections.map(sec =>
      mkSec(sec.title.replace(/_/g, ' ').toUpperCase(), sec.body)
    ).join('');
  } else {
    const resultsHtml = proj.results?.map(r => `<li>${r}</li>`).join('') || '';
    contentHtml = [
      proj.summary    && mkSec('OVERVIEW',               `<p>${proj.summary}</p>`),
      proj.challenge  && mkSec('CHALLENGE',              `<p>${proj.challenge}</p>`),
      proj.solution   && mkSec('SOLUTION & ARCHITECTURE',`<p>${proj.solution}</p>`),
      proj.architecture && mkSec('TECHNICAL DETAILS',    proj.architecture),
      proj.results?.length && mkSec('RESULTS',           `<ul class="detail-results">${resultsHtml}</ul>`),
      proj.techStack?.length && mkSec('TECH STACK',      `<div class="tech-stack">${techHtml}</div>`),
    ].filter(Boolean).join('');
  }

  const isActive = proj.period.includes('진행 중');
  const statusHtml = isActive
    ? `<span class="det-status active"><span class="det-pulse"></span> ACTIVE</span>`
    : `<span class="det-status done">COMPLETED</span>`;
    ...
    <div class="det-layout">
      ...
      <div class="det-main">
        <div class="det-header">
          <div class="det-path">${proj.id} / detail</div>
          ${statusHtml}
          <h1 class="det-title">${proj.title}</h1>
          <p class="det-subtitle">${proj.role}</p>
          <div class="det-chips">${chipsHtml}</div>
          <div class="det-meta-row">
            <div class="det-meta-item">
              <span class="det-meta-k">기간</span>
              <span class="det-meta-v">${proj.period}</span>
            </div>
            <div class="det-meta-item">
              <span class="det-meta-k">역할</span>
              <span class="det-meta-v">${proj.role}</span>
            </div>
          </div>
        </div>
        ${contentHtml}
...
window.addEventListener('DOMContentLoaded', () => {
  // Nav links: force re-render even when hash hasn't changed (e.g., from detail view)
